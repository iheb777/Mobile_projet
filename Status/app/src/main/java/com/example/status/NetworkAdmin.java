...
public class NetworkAdmin extends AppCompatActivity {
    ...
    private void getAMN_SW_AMNANCIEN(String json) throws JSONException {
        ...
        if(temp==1)
        {
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_AMNANCIEN",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getdAMN_SW_AMNNOUV(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_AMNNOUV",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getAMN_SW_DPE(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_DPE",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getAMN_SW_ELE_MC(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_ELE_MC",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getAMN_SW_ELE_MC1(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_ELE_MC1",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getAMN_SW_MAG(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_MAG",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getAMN_SW_NIT(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_NIT",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getAMN_SW_Pers(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_Pers",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getAMN_SW_RG36001(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","AMN_SW_RG36001",new Intent(getApplicationContext(),SecurityManager.class));
