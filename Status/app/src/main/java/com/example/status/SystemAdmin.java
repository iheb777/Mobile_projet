...
public class SystemAdmin extends AppCompatActivity {
    ...
    TextView ltd1,ltd2,ltd3,ltd4,ltd5,ltd6,ltd7,ltd8,ltd9,ltd10;
    ...
    private void getAPPRO_SRV_DHCP_KAV(String json) throws JSONException {
        ...
        if(temp==1)
        {
            ...
            showNotification(getApplicationContext(),"DOWN","APPRO_SRV_DHCP_KAV",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getdDRU_SRV_AD(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_AD",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_Backup(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_Backup",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_ESXI_GPM3(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_ESXI_GPM3",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_GLPI_ANCIEN(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_GLPI_ANCIEN",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_GPM3(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_GPM3",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_GPM3_Backp(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_GPM3_Backp",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_GedAlfresco(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_GedAlfresco",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_Helpdesk(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_Helpdesk",new Intent(getApplicationContext(),SecurityManager.class));
    ...
    private void getDRU_SRV_KAV_HYP(String json) throws JSONException {
        ...
        if(temp==1){
            ...
            showNotification(getApplicationContext(),"DOWN","DRU_SRV_KAV_HYP",new Intent(getApplicationContext(),SecurityManager.class));
